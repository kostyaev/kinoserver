...
import ru.cybern.kinoserver.mobileapi.actors.workers.STCollectWorker;

import java.util.LinkedList;

public class STCollectManager extends UntypedActor {
    ...
    public void onReceive(Object message) throws Exception {
        if(message.equals(Command.START)){
            while(count < max) {
                ActorRef worker = getContext().actorOf(Props.create(STCollectWorker.class), "stcollect" + count++);
